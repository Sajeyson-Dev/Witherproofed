...
public class ModRenderTypes {
    ...
    public static void RenderTypes(final FMLClientSetupEvent event) {
        ...
        RenderTypeLookup.setRenderLayer(ModBlocks.HEAVY_REINFORCED_GHOSTLY_GLASS.get(), RenderType.cutoutMipped());
        RenderTypeLookup.setRenderLayer(ModBlocks.HEAVY_REINFORCED_GHOSTLY_TRANSLUCENT_GLASS.get(), RenderType.translucent());
    }
}